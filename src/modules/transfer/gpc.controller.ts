...
import { GetListResponse } from '../../proto/types/transfers/GetListResponse';
import { GetOneResponse } from '../../proto/types/transfers/GetOneResponse';
import { QueryTransfer__Output } from '../../proto/types/transfers/QueryTransfer';
import { Transfer__Output } from '../../proto/types/transfers/Transfer';
...
export class rpcTransferController {
  private readonly service = new TransferService();

  async getList(
    req: grpc.ServerUnaryCall<QueryTransfer__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Transfer__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
