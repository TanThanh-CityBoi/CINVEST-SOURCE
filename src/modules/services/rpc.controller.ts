...
import { GetListResponse } from '../../proto/types/services/GetListResponse';
import { GetOneResponse } from '../../proto/types/services/GetOneResponse';
import { QueryService__Output } from '../../proto/types/services/QueryService';
import { Service__Output } from '../../proto/types/services/Service';
...
export class rpcServiceController {
  private readonly service = new ServiceService();

  async getList(
    req: grpc.ServerUnaryCall<QueryService__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Service__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
