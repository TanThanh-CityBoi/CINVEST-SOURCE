...
import { Cooperation__Output } from '../../proto/types/cooperations/Cooperation';
import { GetListResponse } from '../../proto/types/cooperations/GetListResponse';
import { GetOneResponse } from '../../proto/types/cooperations/GetOneResponse';
import { QueryCooperation__Output } from '../../proto/types/cooperations/QueryCooperation';
...
import { CooperationService } from './service';

export class rpcCooperationController {
  private readonly service = new CooperationService();

  async getList(
    req: grpc.ServerUnaryCall<QueryCooperation__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Cooperation__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
