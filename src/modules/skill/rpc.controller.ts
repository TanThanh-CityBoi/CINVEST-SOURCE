...
import { GetListResponse } from '../../proto/types/skills/GetListResponse';
import { GetOneResponse } from '../../proto/types/skills/GetOneResponse';
import { QuerySkill__Output } from '../../proto/types/skills/QuerySkill';
import { Skill__Output } from '../../proto/types/skills/Skill';
...
export class rpcSkillController {
  private readonly service = new SkillService();

  async getList(
    req: grpc.ServerUnaryCall<QuerySkill__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Skill__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
