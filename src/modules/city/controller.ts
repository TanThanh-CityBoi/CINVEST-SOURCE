...
import { citySchema, queryCitySchema } from './jois';
import { CityService } from './service';

export class CityController {
  path = PATH.CITY;

  private readonly service = new CityService();
    ...
    return [
      {
        path: '',
        method: METHOD.GET,
        middlewares: [joiMiddleware(queryCitySchema)],
        handler: this.getList,
      },
      {
        path: '',
        method: METHOD.POST,
        middlewares: [joiMiddleware(citySchema)],
        handler: this.create,
      },
      {
        path: '/:id',
  ...
  async getList(
    req: Request,
    res: Response<ApiResponse<TPaginationResult<CityEntity>>>,
  ) {
  ...
  async create(req: Request, res: Response<ApiResponse<CityEntity>>) {
  ...
  async getById(req: Request, res: Response<ApiResponse<CityEntity>>) {
  ...
  async update(req: Request, res: Response<ApiResponse<CityEntity>>) {
