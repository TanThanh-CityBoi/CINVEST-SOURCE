...
import { Education__Output } from '../../proto/types/educations/Education';
import { GetListResponse } from '../../proto/types/educations/GetListResponse';
import { GetOneResponse } from '../../proto/types/educations/GetOneResponse';
import { QueryEducation__Output } from '../../proto/types/educations/QueryEducation';
...
export class rpcEducationController {
  private readonly service = new EducationService();

  async getList(
    req: grpc.ServerUnaryCall<QueryEducation__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Education__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
