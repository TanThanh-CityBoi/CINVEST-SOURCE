...
import { mergeSchema, queryMergeSchema } from './jois';
...
export class MergeController {
    ...
    return [
      {
        path: '',
        method: METHOD.GET,
        middlewares: [joiMiddleware(queryMergeSchema)],
        handler: this.getList,
      },
      {
        path: '',
        method: METHOD.POST,
        middlewares: [joiMiddleware(mergeSchema)],
        handler: this.create,
      },
      {
        path: '/:id',
  ...
  async getList(
    req: Request,
    res: Response<ApiResponse<TPaginationResult<MergeEntity>>>,
  ) {
  ...
  async create(req: Request, res: Response<ApiResponse<MergeEntity>>) {
  ...
  async getById(req: Request, res: Response<ApiResponse<MergeEntity>>) {
  ...
  async update(req: Request, res: Response<ApiResponse<MergeEntity>>) {
