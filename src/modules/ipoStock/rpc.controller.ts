...
import { GetListResponse } from '../../proto/types/ipoStocks/GetListResponse';
import { GetOneResponse } from '../../proto/types/ipoStocks/GetOneResponse';
import { IpoStock__Output } from '../../proto/types/ipoStocks/IpoStock';
import { QueryIpoStock__Output } from '../../proto/types/ipoStocks/QueryIpoStock';
...
export class rpcIpoStockController {
  private readonly service = new IpoStockService();

  async getList(
    req: grpc.ServerUnaryCall<QueryIpoStock__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<IpoStock__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
