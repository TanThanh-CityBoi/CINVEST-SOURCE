...
import { Acquisition__Output } from '../../proto/types/acquisitions/Acquisition';
import { GetListResponse } from '../../proto/types/acquisitions/GetListResponse';
import { GetOneResponse } from '../../proto/types/acquisitions/GetOneResponse';
import { QueryAcquisition__Output } from '../../proto/types/acquisitions/QueryAcquisition';
...
export class rpcAcquisitionController {
  private readonly service = new AcquisitionService();

  async getList(
    req: grpc.ServerUnaryCall<QueryAcquisition__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Acquisition__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
