...
import { Company__Output } from '../../proto/types/companies/Company';
import { GetListResponse } from '../../proto/types/companies/GetListResponse';
import { GetOneResponse } from '../../proto/types/companies/GetOneResponse';
import { QueryCompany__Output } from '../../proto/types/companies/QueryCompany';
...
export class rpcCompanyController {
  private readonly service = new CompanyService();

  async getList(
    req: grpc.ServerUnaryCall<QueryCompany__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Company__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
