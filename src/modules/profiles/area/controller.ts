...
@Controller(CONTROLLER_ENUM.AREA)
@ApiTags(PackageEnum.AREA)
export class AreaController {
  constructor(private readonly service: AreaService) {}

  @Get()
  getList(@Query() query: QueryAreaDto, @Res() res: Response) {
    return this.service.getList(query, res);
  }

  @UseGuards(AuthenticationGuard)
  @Post()
  create(@Body() dto: AreaDto, @Res() res: Response) {
    return this.service.create(dto, res);
  }

  @UseGuards(AuthenticationGuard)
  @Put(':id')
  update(@Param('id') id: string, @Body() dto: AreaDto, @Res() res: Response) {
