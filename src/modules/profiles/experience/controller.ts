...
@Controller(CONTROLLER_ENUM.EXPERIENCE)
@ApiTags(PackageEnum.EXPERIENCE)
export class ExperienceController {
  constructor(private readonly service: ExperienceService) {}

  @Get()
  getList(@Query() query: QueryExperienceDto, @Res() res: Response) {
    return this.service.getList(query, res);
  }

  @UseGuards(AuthenticationGuard)
  @Post()
  create(@Body() dto: ExperienceDto, @Res() res: Response) {
