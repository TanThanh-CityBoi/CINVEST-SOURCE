...
@Controller(CONTROLLER_ENUM.INDUSTRY)
@ApiTags(PackageEnum.INDUSTRY)
export class IndustryController {
  constructor(private readonly service: IndustryService) {}

  @Get()
  getList(@Query() query: QueryIndustryDto, @Res() res: Response) {
    return this.service.getList(query, res);
  }

  @UseGuards(AuthenticationGuard)
  @Post()
  create(@Body() dto: IndustryDto, @Res() res: Response) {
