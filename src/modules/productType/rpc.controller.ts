...
import { ProductType__Output } from '../../proto/types/productTypes/ProductType';
import { QueryProductType__Output } from '../../proto/types/productTypes/QueryProductType';
...
export class rpcProductTypeController {
  private readonly service = new ProductTypeService();

  async getList(
    req: grpc.ServerUnaryCall<QueryProductType__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<ProductType__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
