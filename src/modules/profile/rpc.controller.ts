...
import { GetListResponse } from '../../proto/types/profiles/GetListResponse';
import { GetOneResponse } from '../../proto/types/profiles/GetOneResponse';
import { Profile__Output } from '../../proto/types/profiles/Profile';
import { QueryProfile__Output } from '../../proto/types/profiles/QueryProfile';
...
export class rpcProfileController {
  private readonly service = new ProfileService();

  async getList(
    req: grpc.ServerUnaryCall<QueryProfile__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Profile__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
