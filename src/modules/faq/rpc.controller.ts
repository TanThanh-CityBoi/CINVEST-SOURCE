...
import { FAQ__Output } from '../../proto/types/faq/FAQ';
import { GetListResponse } from '../../proto/types/faq/GetListResponse';
import { GetOneResponse } from '../../proto/types/faq/GetOneResponse';
import { QueryFAQ__Output } from '../../proto/types/faq/QueryFAQ';
...
export class rpcFAQController {
  private readonly service = new FAQService();

  async getList(
    req: grpc.ServerUnaryCall<QueryFAQ__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<FAQ__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
