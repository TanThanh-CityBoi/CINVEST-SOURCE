...
import { Experience__Output } from '../../proto/types/experiences/Experience';
import { GetListResponse } from '../../proto/types/experiences/GetListResponse';
import { GetOneResponse } from '../../proto/types/experiences/GetOneResponse';
import { QueryExperience__Output } from '../../proto/types/experiences/QueryExperience';
...
export class rpcExperienceController {
  private readonly service = new ExperienceService();

  async getList(
    req: grpc.ServerUnaryCall<QueryExperience__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Experience__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
