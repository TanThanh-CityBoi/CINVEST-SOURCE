...
import { GetListResponse } from '../../proto/types/industries/GetListResponse';
import { GetOneResponse } from '../../proto/types/industries/GetOneResponse';
import { Industry__Output } from '../../proto/types/industries/Industry';
import { QueryIndustry__Output } from '../../proto/types/industries/QueryIndustry';
...
export class rpcIndustryController {
  private readonly service = new IndustryService();

  async getList(
    req: grpc.ServerUnaryCall<QueryIndustry__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Industry__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
