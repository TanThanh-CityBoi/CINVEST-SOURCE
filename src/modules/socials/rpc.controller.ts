...
import { GetListResponse } from '../../proto/types/socials/GetListResponse';
import { GetOneResponse } from '../../proto/types/socials/GetOneResponse';
import { QuerySocial__Output } from '../../proto/types/socials/QuerySocial';
import { Social__Output } from '../../proto/types/socials/Social';
...
export class rpcSocialController {
  private readonly service = new SocialService();

  async getList(
    req: grpc.ServerUnaryCall<QuerySocial__Output, GetListResponse>,
  ...
  async create(
    req: grpc.ServerUnaryCall<Social__Output, GetOneResponse>,
    res: grpc.sendUnaryData<GetOneResponse>,
  ) {
    try {
      const request = convertStringToDate(req.request);
