// Original file: src/proto/proto/companyDirectorMapping.proto
...
export interface CompanyDirectorMapping {
  'id'?: (number);
  'createdAt'?: (string);
  'updatedAt'?: (string);
  'createdBy'?: (string);
  ...
  'director'?: (_profiles_Profile | null);
  '_id'?: "id";
...
export interface CompanyDirectorMapping__Output {
  'id'?: (number);
  'createdAt'?: (string);
  'updatedAt'?: (string);
  'createdBy'?: (string);
  ...
  'director'?: (_profiles_Profile__Output | null);
  '_id': "id";
  '_createdAt': "createdAt";
  '_updatedAt': "updatedAt";
  '_createdBy': "createdBy";
