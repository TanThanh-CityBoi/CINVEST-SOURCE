...
import type { ArchiveRecordServiceClient as _archiveRecords_ArchiveRecordServiceClient, ArchiveRecordServiceDefinition as _archiveRecords_ArchiveRecordServiceDefinition } from './archiveRecords/ArchiveRecordService';
...
export interface ProtoGrpcType {
  ...
  archiveRecords: {
    ArchiveRecord: MessageTypeDefinition
    ArchiveRecordService: SubtypeConstructor<typeof grpc.Client, _archiveRecords_ArchiveRecordServiceClient> & { service: _archiveRecords_ArchiveRecordServiceDefinition }
    GetListResponse: MessageTypeDefinition
    QueryArchiveRecord: MessageTypeDefinition
  }
  areas: {
